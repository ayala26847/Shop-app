...
-- Main categories
('11111111-1111-1111-1111-111111111111', 'categories.bakery', 'חומרי אפייה ומוצרי מאפייה / Bakery products and baking supplies', 1, true),
('22222222-2222-2222-2222-222222222222', 'categories.dairy', 'מוצרי חלב טריים / Fresh dairy products', 2, true),
('33333333-3333-3333-3333-333333333333', 'categories.cakes', 'עוגות טריות ומיוחדות / Fresh and specialty cakes', 3, true),
('44444444-4444-4444-4444-444444444444', 'categories.cookies', 'עוגיות ומתוקים / Cookies and sweets', 4, true),
('55555555-5555-5555-5555-555555555555', 'categories.frozen', 'מוצרים קפואים / Frozen products', 5, true),
('66666666-6666-6666-6666-666666666666', 'categories.beverages', 'משקאות / Beverages', 6, true),
('77777777-7777-7777-7777-777777777777', 'categories.snacks', 'חטיפים ופיצוחים / Snacks and nuts', 7, true),
('88888888-8888-8888-8888-888888888888', 'categories.fruits', 'פירות טריים / Fresh fruits', 8, true);
...
-- Bakery products
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111'), -- Whole wheat bread -> Bakery
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '11111111-1111-1111-1111-111111111111'), -- Challah -> Bakery

-- Cakes
('cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333'), -- Chocolate cake -> Cakes
('dddddddd-dddd-dddd-dddd-dddddddddddd', '33333333-3333-3333-3333-333333333333'), -- Cheesecake -> Cakes

-- Dairy products
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '22222222-2222-2222-2222-222222222222'), -- Milk -> Dairy
('ffffffff-ffff-ffff-ffff-ffffffffffff', '22222222-2222-2222-2222-222222222222'), -- Cheese -> Dairy

-- Cookies
('gggggggg-gggg-gggg-gggg-gggggggggggg', '44444444-4444-4444-4444-444444444444'), -- Chocolate chip cookies -> Cookies
('hhhhhhhh-hhhh-hhhh-hhhh-hhhhhhhhhhhh', '44444444-4444-4444-4444-444444444444'), -- Rugelach -> Cookies

-- Beverages
('iiiiiiii-iiii-iiii-iiii-iiiiiiiiiiii', '66666666-6666-6666-6666-666666666666'), -- Orange juice -> Beverages
('jjjjjjjj-jjjj-jjjj-jjjj-jjjjjjjjjjjj', '66666666-6666-6666-6666-666666666666'); -- Cold brew -> Beverages
